        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header row align-items-center">
                    <h4 class="card-title">Lista de trasvase&nbsp</h4>
                    {{-- @can('Crear empleado') --}}
                    <a href="{{ route('trasvase.registrar')}}" id='crear-cargo'
                        class="btn btn-outline-success btn-sm">Agregar trasvase</a>
                    {{-- @endcan --}}
                </div>
                <div class="card-body">
...
<script>
    ...
    autoWidth: false,
    ajax: "{{ route('trasvase.index') }}",
    columns: [
      {data: 'id', name: 'id'},
      {data: 'tanque_id', name: 'tanque_id'},
