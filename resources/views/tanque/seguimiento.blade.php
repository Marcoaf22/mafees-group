            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-2"></div>
                        <div id="myMap" class="col-8" style="height:600px; width:900px"></div>
                        <div class="col-2"></div>
                    </div>
...
if ($tanque->estado_id == 2) {
marker1= L.marker([{{ $tanque->latitud}}, {{ $tanque->longitud}}],{
title: 'hola',
opacity: 1,
}).addTo(myMap)
marker1.bindPopup("<a href=''> Tanque #{{ $tanque->id }} </a>").openPopup();
} else {
marker1= L.marker([{{ $tanque->latitud}}, {{ $tanque->longitud}}],{
icon: myIcon,
title: 'hola',
    ...
    function cargar(){
        ...
        tanques.forEach(tanque => {
            if(tanque.estado_id == 2){
                ...
                marker1.bindPopup("<a href='http://mafees-group.test/dashboard/tanque/detalle/" + tanque.id +"'> Tanque #"+ tanque.id  +" </a>").openPopup();
            }else{
